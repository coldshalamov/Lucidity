...
/// Run the stock WezTerm GUI command line and native event loop.
///
/// Keeping this bootstrap in the library lets product binaries reuse the
/// renderer and mux initialization without changing the stock executable.
pub fn run_cli() {
    #[cfg(feature = "dhat-heap")]
